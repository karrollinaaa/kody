...
def dane_z_pliku(nazwa_pliku):
    ...
    with open(nazwa_pliku, 'r', newline='', encoding='utf-8') as plik:
        ...
        for rekord in tresc:
            ...
            dane.append(rekord)  # dodoawanie rekordów do listy
        return dane
...
def kwerenda_1(cur):
    ...
    for row in wyniki:  # odczytywanie ko9lejnych wyników
...
def main(args):
    ...
    filmy.pop(0)  # usuń rekord z listy
    ...
    con.commit()  # zatwierdzanie zmian w bazie
